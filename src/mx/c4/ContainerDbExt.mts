...
// External container database. C4-PlantUML:
// ContainerDb_Ext → $getElementLine("database", "external_container", …)
// — database (cylinder) shape KEPT, colour external grey. Shape ==
// ContainerDb; colour == CONTAINER_EXT (was flattened to grey rect).
class ContainerDbExt {
    static async label() {
